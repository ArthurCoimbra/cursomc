...
import com.arthurdsc.cursomc.domain.Estado;
import com.arthurdsc.cursomc.domain.ItemPedido;
import com.arthurdsc.cursomc.domain.Pagamento;
import com.arthurdsc.cursomc.domain.PagamentoComBoleto;
import com.arthurdsc.cursomc.domain.PagamentoComCartao;
...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "maria@gmail.com", "91142566064", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27999473628", "11998780976"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "ana@gmail.com", "60279859090", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli2.addPerfil(Perfil.ADMIN);		
		cli2.getTelefones().addAll(Arrays.asList("2799656878", "27846374637"));
		
		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 203", "Jardim", "38220044", c1, cli1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", c2, cli1);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "270", "Apto 605", "Praia do Canto", "29678987", c2, cli2);
